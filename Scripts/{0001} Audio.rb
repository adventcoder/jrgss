...
loop do
  ...
  if Input.repeat?(:B)
    ...
    if Input.press?(:CTRL)
      ...
      Audio.bgm_play('Audio/BGM/Airship', 50 + rand(51), 50 + rand(101), 5000000) # but not here?
    else
